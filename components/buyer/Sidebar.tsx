...
import { BellRing, BriefcaseBusiness, CircleHelp, FileText, House, PackageOpen, ShoppingBasket, ShoppingCart, Settings, ShieldCheck, Truck, WalletCards } from 'lucide-react';

const navItems = [
  { label: 'Dashboard', href: '#', active: true, icon: House },
  { label: 'Marketplace', href: '#', active: false, icon: ShoppingBasket },
  { label: 'My Orders', href: '#', active: false, icon: PackageOpen },
  { label: 'Transactions', href: '#', active: false, icon: FileText },
  { label: 'Complaints', href: '#', active: false, icon: ShieldCheck },
    ...
    <aside className="flex h-screen w-[270px] flex-col border-r border-[#dfe7df] bg-[#f3f7f3] px-4 py-4">
      <div className="mb-5 flex items-center gap-3 px-2 pt-2">
        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#dff3e4] ring-1 ring-[#0f7b4a]/20">
          <ShoppingCart className="h-5 w-5 text-[#0f7b4a]" />
        </div>
        <div>
          <div className="text-[2rem] font-black leading-none tracking-[-0.06em] text-[#113f35]">AgriLink</div>
          <div className="mt-1 text-[0.62rem] font-semibold uppercase tracking-[0.12em] text-slate-500">Buyer Portal</div>
        </div>
      </div>

      <div className="mb-4 rounded-[18px] border border-[#edf0ee] bg-white px-3 py-2 shadow-sm">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#ddf4e4] text-[#0f7b4a] ring-1 ring-[#0f7b4a]/10">
            <BriefcaseBusiness className="h-5 w-5" />
          </div>
          <div>
            <div className="text-[0.95rem] font-black tracking-[-0.03em] text-[#123a2d]">RetailMart Traders</div>
            <div className="text-[0.68rem] text-slate-500">Buyer • Retail • Wholesale</div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-auto overflow-hidden rounded-[26px] border border-[#d9e7db] bg-gradient-to-b from-[#edf8ef] to-[#ddeede] p-3 shadow-inner">
        <div className="relative h-[190px] overflow-hidden rounded-[20px] bg-gradient-to-b from-[#ebf9ed] via-[#d9edd9] to-[#b9d7af]">
          <div className="absolute inset-x-0 bottom-0 h-[54%] bg-[linear-gradient(180deg,rgba(32,79,50,0.18),rgba(17,69,50,0.32)),url('https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=1200&q=80')] bg-cover bg-center opacity-90" />
          ...
          <div className="absolute inset-x-0 bottom-0 px-3 pb-6 text-center text-[#123d2d]">
            <div className="text-[1.1rem] font-black tracking-[-0.04em]">Fresh Produce</div>
            <div className="text-[0.96rem] font-bold tracking-[-0.03em]">Stronger Supply Chains</div>
            <div className="mt-1 text-[0.64rem] font-medium text-[#1d4e3e]">A Healthier Tomorrow</div>
          </div>
        </div>
      </div>
    </aside>
