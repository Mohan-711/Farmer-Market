...
const actions = [
  { label: 'Request Pickup', icon: Truck, tone: 'bg-[#eaf7ee] text-[#0f7b4a]' },
  { label: 'View Inventory', icon: ClipboardList, tone: 'bg-[#edf5ff] text-[#3b82f6]' },
  { label: 'Sell to Buyers', icon: PackageCheck, tone: 'bg-[#fff1dc] text-[#d29d2a]' },
  { label: 'Raise Complaint', icon: AlertTriangle, tone: 'bg-[#fbe6ef] text-[#c84a73]' },
];
