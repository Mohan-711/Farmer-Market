...
const stats = [
  { label: 'Available Crops', value: '45', change: '+12 new this week', delta: 'up', accent: 'bg-[#e8f7ee]', icon: ClipboardList, iconColor: 'text-[#0f7b4a]' },
  { label: 'Offers Sent', value: '12', change: '3 pending response', delta: 'neutral', accent: 'bg-[#edf5ff]', icon: Box, iconColor: 'text-[#1e6fc7]' },
  { label: 'Purchased Crops', value: '6', change: '+2 this month', delta: 'up', accent: 'bg-[#fff1dc]', icon: CheckCircle2, iconColor: 'text-[#d29d2a]' },
  { label: 'Inventory Stock', value: '3,500 kg', change: 'Across 4 crops', delta: 'up', accent: 'bg-[#f0ecff]', icon: BadgeDollarSign, iconColor: 'text-[#6747d4]' },
];
