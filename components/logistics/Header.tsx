    ...
    <header className="flex items-center justify-between gap-4 border-b border-[#dfe9df] bg-[#f4f8f4] px-5 py-4">
      <div className="flex items-center gap-4">
        ...
        <div className="relative hidden w-[440px] md:block">
          ...
          <input
            aria-label="Search deliveries, locations, crops, or delivery ID"
            placeholder="Search deliveries, locations, crops, or delivery ID..."
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 rounded-full border border-[#dfe6df] bg-white px-2 py-1.5 shadow-sm">
          ...
          <div className="hidden text-left sm:block">
            <div className="text-[0.72rem] font-bold text-[#103d33]">SpeedMove Logistics</div>
            <div className="text-[0.62rem] text-slate-500">Operations</div>
          </div>
