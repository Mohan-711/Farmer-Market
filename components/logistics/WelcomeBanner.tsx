...
export function WelcomeBanner() {
  return (
    <section className="relative overflow-hidden rounded-[28px] bg-[#dfeae7] p-6 shadow-[0_20px_40px_rgba(17,50,39,0.06)]">
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(255,255,255,0.12),rgba(255,255,255,0.06)),url('https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?auto=format&fit=crop&w=1200&q=80')] bg-cover bg-center opacity-85" />
      ...
      <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h1 className="text-[2.2rem] font-black leading-[1.05] tracking-[-0.06em] text-[#112d26] sm:text-[3rem]">
            Welcome back, SpeedMove Logistics!
          </h1>
          <p className="mt-2 text-lg text-[#173f35]">Delivering fresh produce to a better tomorrow.</p>
        </div>

        <div className="rounded-[22px] border border-white/50 bg-white/15 px-4 py-3 text-right shadow-lg backdrop-blur-sm">
          <div className="text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-[#1a4d3f]">Connecting Farms</div>
          <div className="mt-1 text-xl font-black tracking-[-0.05em] text-[#113f35]">to Markets</div>
          <div className="text-lg font-semibold text-[#144934]">Across India</div>
        </div>
      </div>
    </section>
  );
